...
namespace PPC.Module.Shop.ViewModels
{
    public class ShoppingCartViewModel : ObservableObject
    {
        ...
        {
            get => _currentArticleSelectorViewModel;
            set
            {
        ...
        {
            ShopArticleItem existingArticle = ShoppingCartArticles.FirstOrDefault(x => x.Article.Guid == article.Guid);
            if (existingArticle == null)
            {
                existingArticle = new ShopArticleItem
                {
                    Article = article,
                    Quantity = 0
                };
                ShoppingCartArticles.Add(existingArticle);
            }
        ...
        {
            AddArticle(args.Article, args.Quantity);
        }
    }
